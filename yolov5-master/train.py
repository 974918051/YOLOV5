...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='../Mushrooms/data.yaml', help='data.yaml path')#数据
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch_mac.yaml', help='hyperparameters path')
